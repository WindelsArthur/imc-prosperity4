...
**Final 3-day PnL: +524**  ·  mode = `MM`

## Universe stats (day-2)
- spread_p50 = 14  ·  mid_std = 682  ·  bucket = `WEAK_DRIFT`
- ADF p = 0.804  ·  KPSS p = 0.01  ·  OU half-life = 5431.4
- AR(1)-on-Δmid coef = 0.015  (p = 0.135)
- lattice_ratio = 0.142

## Phase 1 — best FV (composite-z ranked)
- FV: `ar2_dx`  ·  IC|abs| = 0.009  ·  half-life = 0.14  ·  res/spread = 0.64

## Phase 2 — best in-sim threshold config (taker)
- FV `ar2_dx`  ·  z_in=2.50  z_out=0.00  sizing=fixed
- pnl_A (day-3 OOS) = -10925  ·  pnl_B (day-4 OOS) = -7404  ·  avg_daily = -9164
- min_sharpe across folds = -5.98
...
## Expected day-5 PnL
≈ +175 (= total / 3, given walk-forward stability).
