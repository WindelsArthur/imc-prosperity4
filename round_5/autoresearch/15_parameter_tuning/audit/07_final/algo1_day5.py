...
ALL_PAIRS = [
    ...
    ("PEBBLES_S", "GALAXY_SOUNDS_BLACK_HOLES", -0.7690102978088632, 17748.75572133899),
    ("SLEEP_POD_POLYESTER", "SNACKPACK_STRAWBERRY", 2.321531567565331, -13007.664098057976),
    ...
    ("PEBBLES_S", "GALAXY_SOUNDS_BLACK_HOLES", -0.7694153339426255, 17755.05730162346),
    ("PEBBLES_S", "OXYGEN_SHAKE_GARLIC", -0.7727027691234808, 18147.2455211014),
    ("PEBBLES_S", "GALAXY_SOUNDS_BLACK_HOLES", -0.7693413888529935, 17753.863113292795),
    ...
    ("SLEEP_POD_POLYESTER", "UV_VISOR_AMBER", -0.9214745708124292, 19132.670249221737),
    ("SLEEP_POD_POLYESTER", "UV_VISOR_AMBER", -0.9225733259659192, 19139.766267343028),
    ("SLEEP_POD_POLYESTER", "UV_VISOR_AMBER", -0.922343009134443, 19138.28450459743),
    ...
    ("SLEEP_POD_POLYESTER", "SNACKPACK_STRAWBERRY", 2.3527089540184907, -13348.896096434935),
    ("PEBBLES_S", "PANEL_2X4", -1.1017757013394047, 21342.74453333796),
    ("SLEEP_POD_POLYESTER", "SNACKPACK_STRAWBERRY", 2.351705130651962, -13337.84100339962),
    ("SLEEP_POD_POLYESTER", "UV_VISOR_AMBER", -0.9159057482909352, 19095.564289887556),
    ...
    ("SLEEP_POD_POLYESTER", "SNACKPACK_STRAWBERRY", 2.3479699380283714, -13296.739921940798),
    ...
    ("GALAXY_SOUNDS_DARK_MATTER", "UV_VISOR_YELLOW", 0.3689380820623889, 6183.87642392147),
    ...
    ("UV_VISOR_AMBER", "SLEEP_POD_POLYESTER", -0.9552593780062484, 19215.393329985007),
    ...
    ("SNACKPACK_STRAWBERRY", "SLEEP_POD_POLYESTER", 0.3242444420387684, 6870.024333704087),
    ("PEBBLES_M", "ROBOT_IRONING", -0.7289481998161417, 16609.41297806013),
    ("GALAXY_SOUNDS_DARK_MATTER", "UV_VISOR_YELLOW", 0.3725008942252533, 6144.994437218317),
    ("MICROCHIP_CIRCLE", "OXYGEN_SHAKE_CHOCOLATE", 0.7901625693229987, 1663.4791606526774),
    ("UV_VISOR_AMBER", "SLEEP_POD_POLYESTER", -0.959518962160613, 19272.865267578487),
    ("GALAXY_SOUNDS_DARK_MATTER", "UV_VISOR_YELLOW", 0.3717316422735988, 6153.3682394740235),
    ...
    ("UV_VISOR_AMBER", "SLEEP_POD_POLYESTER", -0.9593041446890244, 19270.02541757595),
    ("PANEL_2X4", "PEBBLES_S", -0.6240537370367631, 16839.944282279965),
    ("UV_VISOR_AMBER", "SLEEP_POD_POLYESTER", -0.9584839001822808, 19259.19503065382),
    ("SNACKPACK_STRAWBERRY", "SLEEP_POD_POLYESTER", 0.3254754528137944, 6852.821516561052),
    ("PANEL_2X4", "PEBBLES_S", -0.623036339105657, 16836.65554768176),
    ("PEBBLES_XS", "UV_VISOR_AMBER", 1.3931194919566812, -3617.915393109361),
    ("MICROCHIP_CIRCLE", "OXYGEN_SHAKE_CHOCOLATE", 0.7981102802401778, 1587.8057425343873),
    ("PEBBLES_XS", "UV_VISOR_AMBER", 1.388561655273618, -3593.107091220367),
    ("GALAXY_SOUNDS_DARK_MATTER", "UV_VISOR_YELLOW", 0.3723433389937314, 6146.707957072923),
    ("PEBBLES_XS", "UV_VISOR_AMBER", 1.3923024535988002, -3613.253559847587),
    ("PANEL_2X4", "PEBBLES_XS", -0.368433368145386, 13999.24539348717),
    ("PEBBLES_XS", "UV_VISOR_AMBER", 1.3933397217769254, -3619.163706808231),
    ("SNACKPACK_STRAWBERRY", "SLEEP_POD_POLYESTER", 0.3254437803404871, 6853.2973690188455),
    ...
    ("SNACKPACK_STRAWBERRY", "SLEEP_POD_POLYESTER", 0.3253198362113076, 6855.153570031603),
    ("SNACKPACK_STRAWBERRY", "UV_VISOR_AMBER", -0.3240128557337444, 13273.34168277188),
    ...
    ("SNACKPACK_STRAWBERRY", "UV_VISOR_AMBER", -0.3255807704052871, 13283.150763786382),
    ...
    ("SNACKPACK_STRAWBERRY", "UV_VISOR_AMBER", -0.3258280537962662, 13284.622127262548),
    ("SNACKPACK_STRAWBERRY", "UV_VISOR_AMBER", -0.3258897302582937, 13284.981103042262),
    ...
    ("TRANSLATOR_ECLIPSE_CHARCOAL", "PANEL_1X2", -0.3546280614204017, 12977.917357773027),
    ("GALAXY_SOUNDS_DARK_MATTER", "MICROCHIP_CIRCLE", -0.3822618721279026, 13749.153717392825),
    ("TRANSLATOR_ECLIPSE_CHARCOAL", "PANEL_1X2", -0.3559039252245703, 12989.08737985738),
    ("SNACKPACK_VANILLA", "PANEL_2X4", 0.1490704816817463, 8418.012472433675),
    ("TRANSLATOR_ECLIPSE_CHARCOAL", "PANEL_1X2", -0.3542686505312782, 12974.769710486617),
    ...
    ("TRANSLATOR_ECLIPSE_CHARCOAL", "PANEL_1X2", -0.362584721665881, 13047.433376159095),
    ...
    ("SNACKPACK_PISTACHIO", "MICROCHIP_OVAL", 0.0907151516120979, 8753.805527706438),
    ("SNACKPACK_PISTACHIO", "MICROCHIP_OVAL", 0.0906959920029524, 8753.86307704348),
    ("SNACKPACK_PISTACHIO", "MICROCHIP_OVAL", 0.0906269634640881, 8754.06368970703),
