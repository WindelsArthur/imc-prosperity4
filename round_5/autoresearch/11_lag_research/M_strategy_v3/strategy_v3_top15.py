...
CROSS_GROUP_PAIRS = [
    ...
    ("PANEL_2X4", "OXYGEN_SHAKE_GARLIC", 0.554, 4653.1, 150.0),
    ("GALAXY_SOUNDS_DARK_MATTER", "UV_VISOR_YELLOW", 0.373, 6145.0, 150.0),
    ("SNACKPACK_STRAWBERRY", "SLEEP_POD_POLYESTER", 0.325, 6852.8, 150.0),
    ("SNACKPACK_CHOCOLATE", "PANEL_2X4", -0.217, 12289.6, 100.0),
]
