...
**Group:** `microchip` | **v3 3-day PnL:** +784 | **mr_v6 3-day PnL:** +0 | **Position cap (v3):** 10
...
- **Rationale:** v3 PnL +784 — moderate; baseline kept

## 2 ranked alternatives
1. IDLE — mr_v6 chose this (PnL=0); v3 yields +784
