...
**Group:** `microchip` | **v3 3-day PnL:** +1,048 | **mr_v6 3-day PnL:** +5,446 | **Position cap (v3):** 10
...
- ROUND_5/autoresearch/mr_study/07_findings/per_product/MICROCHIP_OVAL.md
...
- ROUND_5/autoresearch/mr_study/01_fair_value_zoo/per_product/MICROCHIP_OVAL/diagnostics.csv
- ROUND_5/autoresearch/14_lag_research/M_strategy_v3/strategy_v3_top100.py
- ROUND_5/autoresearch/13_round2_research/A_sine/plots/MICROCHIP_OVAL.png
...
- **Rationale:** v3 PnL +1,048 — moderate; baseline kept; Day-of-day KS break flagged — conservative inventory skew
